...
<option value="kades">Camat</option>
<option value="sekdes">Sekcam</option>
</select>
...
Kecamatn  <?php echo strtoupper($desa['nama']) ?><br/></strong>
<?php echo ucwords($desa['alamat']) ?> Pos. <?php echo $desa['pos'] ?>
</div>
<!-- akhir kepala surat -->
...
Camat <?php echo $desa["kecamatan"] ?>, Kabupaten <?php echo $desa["kabupaten"] ?> menerangkan dengan 
...
<div id="par_penutup"><span class="masuk_alinea">&nbsp;</span>Demikian Surat Keterangan ini diberikan, dengan sebenarnya dan untuk dipergunakan sebagaimana mestinya.</div>
<div class="tanda_tangan" style="float:right">
	<div>Saketi, <?php echo date("d-m-Y") ?></div>
...
function isi_nip(elm){
	if($(elm).val() == "kades"){
		...
		$("#nama_pejabat").html("<span style='text-transform:uppercase;text-decoration:underline'>"+kades+"</span><br />"+kades_nip);
		}
	else {
