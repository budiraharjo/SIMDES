...
/*
 *      daftar_penduduk.php
 *      Menampilkan data penduduk dari tabel user
 */
...
$sql_total = "SELECT count(*) FROM mutasi_warga";		
...
$sql = "SELECT id_mutasi, id_warga, jenis_mutasi, tanggal, keterangan FROM mutasi_warga";
...
?>
        ...
        <div class="breadcrumbs">Menampilkan seluruh laporan keluar/mutasi</div>
</div>
<div id="stylized" class="select-bar">
	...
	<select onchange="tambah_field_cari(this)" id="kolom">
       ...
       <span>
       <a href="lapmutasi.php" title="download ke PDF"><img src="img/ods.png" >Download Pdf Data</a>
       </span>
...
function hal(elm){
	...
	var tabel = "mutasi_warga";
	var nama_id = "id_warga";
...
function hapus_inputan(elm){
	...
	var kolom = $(elm).prev().attr("password");
	$(elm).prev().remove();
	$(elm).remove();
