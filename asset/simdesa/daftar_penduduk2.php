...
$sql = "SELECT no_ktp,nama,agama, t_lahir, tgl_lahir, j_kel,gol_darah,w_negara,pendidikan , dusun, pekerjaan,s_nikah FROM warga";
...
?>
        ...
        <div class="breadcrumbs">Menampilkan seluruh daftar penduduk</div>
<div class="top-bar">
...
<div id="stylized" class="select-bar">
	...
	<select onchange="tambah_field_cari(this)" id="kolom">
       ...
       <a href="lapenduduk.php" title="download ke pdf"><img src="img/ods.png" >Download Pdf Data</a>
